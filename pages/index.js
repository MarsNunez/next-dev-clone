          ...
          <div className="left-box hidden md:block mt-2">
            <div>
              {primaryLabels.map((label, index) => (
                <div
                  key={index}
                  className="cursor-pointer flex items-center px-3 py-2 rounded-md w-60 font-light text-md group text-gray-800 hover:text-indigo-700 hover:bg-indigo-100"
                >
            ...
            <div className="mt-4">
              ...
              <div className="w-60 flex gap-2 my-4 ml-1">
                {socials.map((social, index) => (
                  <div
                    key={index}
                    className="h-10 w-10 flex items-center justify-center rounded-md hover:bg-indigo-100 group cursor-pointer"
                  >
                    <i
            ...
            <div>
              ...
              <div className="w-fit max-h-80 overflow-scroll">
                {tagsLabels.map((label, index) => (
                  <div
                    key={index}
                    className="cursor-pointer px-3 py-2 rounded-md w-60 font-light text-md hover:underline text-gray-800 hover:text-indigo-700 hover:bg-indigo-100"
                  >
